      ...
      <div className="searchSection">
        <div className="searchRow">
          <div className="searchCategory">
            <label htmlFor="category">검색 : </label>
            <select
              id="category"
              value={searchCnum}
            ...
            >
              ...
              {category.map((category, index) => (
                <option key={index} value={category.cnum}>
                  {category.name}
                </option>
              ))}
            </select>
        ...
        <div className="searchRow">
          ...
          <button
            ...
            onClick={async () => {
              console.log(
                `검색:${search.searchCategory} ${search.searchWord}, ${searchRegion}, ${searchRstart}, ${searchRend}`
              );
              searchSpaces();
            }}
          >
      ...
      <div className="spaces">
        {spaceList
          ? spaceList.map((spaceDTO, idx) => {
              return <SpaceBoxComponent key={idx} record={spaceDTO} />;
            })
          : null}
      </div>
    </div>

                ...
                <div className='mypageModal '>
                    {rerveData.space && (
                        <div className="modal-content scrollbar">
                            ...
                            {(rerveData.space.spaceimage[0])&&(<img src={`http://rentmon-jb.s3.ap-northeast-2.amazonaws.com/space_images/${rerveData.space.spaceimage[0].realName}`} alt='savefilename'/>)}

    ...
    (popup.space)&&(
        ...
        <div className='qnamodal modal'>
            ...
            <div className='spaceInfo'>
                {(popup.space.spaceimage&&popup.space.spaceimage.length>0)&&(<img src={`http://rentmon-jb.s3.ap-northeast-2.amazonaws.com/space_images/${popup.space.spaceimage[0].realName}`}/>)}

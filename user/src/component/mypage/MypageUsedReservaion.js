            ...
            <div className="recentresevation-container"  >
                ...
                <div className='recentresevation-wrapper'>
                    <div className='img-box'>
                        {(reservation.space.spaceimage[0])&&(<img src={`http://rentmon-jb.s3.ap-northeast-2.amazonaws.com/space_images/${reservation.space.spaceimage[0].realName}`} alt={reservation.space.spaceimage[0].realName}/>)}
